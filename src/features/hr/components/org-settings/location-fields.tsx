...
export function LocationFields({ values, parentOptions, onChange }: Props) {
  ...
  return (
    <div className="loc-fields">
      {/* Row 1: Parent + Phone */}
      <div className="loc-fields__grid">
        <label className="loc-fields__label">
          Parent Location
          <Select
      ...
      {/* Remote toggle */}
      <div className="loc-fields__toggle">
        <div className="loc-fields__toggle-info">
          <span className="loc-fields__toggle-title">Remote location</span>
          <span className="loc-fields__toggle-desc">No physical address — people work from anywhere</span>
        </div>
        <Switch
      ...
      {/* Timezone */}
      <div className="loc-fields__grid loc-fields__grid--half">
        <label className="loc-fields__label">
          Timezone
          <Select
            ...
            placeholder={values.isRemote ? "Select timezone..." : "Auto-filled from country"}
          />
        </label>
      </div>
    </div>
