  ...
  return (
    <div className="login">
      <div className="login__card">
        ...
        {/* Google SSO */}
        {allowGoogle && (
          <Button variant="outline" className="login__google" onClick={handleGoogleSSO} disabled={loading}>
        ...
        {allowPassword && (
          <p className="login__toggle">
            {mode === "signin" ? (
              <>Don&apos;t have an account? <Button variant="link" onClick={() => { setMode("signup"); setError(""); }}>Sign up</Button></>
            ) : (
              <>Already have an account? <Button variant="link" onClick={() => { setMode("signin"); setError(""); }}>Sign in</Button></>
            )}
          </p>
        )}

        <p className="login__powered">Powered by Optivo</p>
      </div>
    </div>
  );
}
